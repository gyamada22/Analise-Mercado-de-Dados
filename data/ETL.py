...
def padronizar_skill(skill):
    ...
    if 'python' in s:
        return 'Python'
    mapeamento = {
        'java': 'Java', 'sql': 'SQL', ' r ': 'R',
        'power bi': 'Power BI', 'tableau': 'Tableau', 'looker': 'Looker', 'qlik': 'Qlik',
        'excel': 'Excel Avançado', 'vba': 'Excel Avançado', 'power query': 'Excel Avançado', 'power pivot': 'Excel Avançado',
        'machine learning': 'Machine Learning', 'deep learning': 'Deep Learning', 'nlp': 'NLP',
        'inteligência artificial': 'IA', ' ia ': 'IA',
        'estatística': 'Estatística', 'probabilidade': 'Estatística',
        'etl': 'ETL', 'elt': 'ETL', 'airflow': 'ETL', 'dbt': 'ETL',
